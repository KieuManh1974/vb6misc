...
Private Sub Form_Activate()
    ...
    oPlanet2.Tilt = pi2 * 45 / 360
    oPlanet2.TiltOffset = pi2 * 180 / 360
    oPlanet2.Radius = 6372.795477598 * 1000
    oPlanet2.RateOfRevolution = pi2 / (23.9344696 * 60 * 60)
    oPlanet2.LongitudeOffset = pi2 * 0 / 360
    ...
    Do
        ...
        Debug.Print Format$(dDateOffset + dTime / 60 / 60 / 24, "DD/MM/YYYY HH:MM") & "   :   " & Format$(oPlanet2.PolarPosition(oPlanet1.Position, pi2 * 0 / 360, pi2 * 0 / 360, dTime).x, "0.000")

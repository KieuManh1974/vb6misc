...
Private Sub ReadTimes(sBusStop As String)
    ...
    While lRouteStart <> 0
        ...
        If Not IsDate(sTime) Then
            moBusses.AddBus sRoute, sBusStop, sDestination, ClearSeconds(Val(sTime) / 1440 + Now()), False
        Else
            moBusses.AddBus sRoute, sBusStop, sDestination, Expectedtime(sTime), True
        End If

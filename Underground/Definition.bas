...
Public Const TextSeparation As Double = 20

Public Const LineGap As Double = 10 '19
Public Const FontSize As Double = 12
...
Public Sub DoDefinition()
    ...
    sDef = sDef & "position := AND ['P:'], reference, ['|'], name, ['|'], pos, ['|'], pos, ['|'], pos, ['|'], pos, ['|'], pos, ['|'], pos;"

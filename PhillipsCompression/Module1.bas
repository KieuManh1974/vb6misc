...
Sub main()
    ...
    sPath = App.Path & "\Lovers Complaint.txt"
    ...
    Do
        ...
        If mlHighestFrequencyPair > 4 Then
            ...
            Debug.Print Len(sText) & ":" & msMostCommonPair
        Else
            Exit Do
        End If
    Loop
...
Private Sub FindLeastUsedSymbol()
    ...
    For lCheck = 0 To 255
        If mlCharCount(lCheck) < lLowestFrequency Then
            lLowestFrequency = mlCharCount(lCheck)
            lLowestFrequencySymbol = lCheck
...
Private Sub WriteFile()
    ...
    For lIndex = mlDictionarySize To 0 Step -1

...
'    nOffsetY = Printer.Height / Printer.TwipsPerPixelY / 2
    ...
    For fTime = 0 To CDbl(3600) * 24 * 365 Step fStep
...
'                    Printer.Print lMinute \ 60
                    Me.CurrentX = oPos(lMinute, lDay).x - Me.TextWidth(lMinute \ 60)
...
'    Printer.Line (nOffsetX, nOffsetY - 50)-Step(0, 100), vbBlack
    Me.Line (nOffsetX - fScaling, nOffsetY)-Step(50 + fScaling, 0), vbBlack
    Me.Line (nOffsetX, nOffsetY - 50)-Step(0, 100), vbBlack

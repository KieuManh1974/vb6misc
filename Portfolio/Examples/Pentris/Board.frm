...
Private shapes(1 To 18) As String
...
'    shapes(7) = "SLSRDSRS"
    ...
    shapes(1) = "SUSUSDDDSDS"
    shapes(2) = "SUSUSDDDSRS"
    shapes(3) = "SUSUSDDRSLDS"
    shapes(4) = "SUSDRSLDSDS"
    shapes(5) = "SUSUSDDDSLS"
    shapes(6) = "SUSUSDDRSDS"
    shapes(7) = "SRSDSLSUUS"
    shapes(8) = "SUSUSDDRSRS"
    shapes(9) = "SLSRRSLUSUS"
    shapes(10) = "SUSDLSRDSRS"
    shapes(11) = "SUSLSDDRSRS"
    shapes(12) = "SUSRSDDSLS"
    shapes(13) = "SUSUSLDDSDS"
    shapes(14) = "SUSLDSDSRS"
    shapes(15) = "SUSRDSDLSLS"
    shapes(16) = "SUSRSDDLSLS"
    shapes(17) = "SUSRDSDLSLUS"
    shapes(18) = "SLSUSRDDSRS"
        ...
        Select Case Mid$(shapes(iShape), iIndex, 1)
            Case "S"
                If Not fill Then
                    ...
                    If xpos > UBound(World) Or ypos > UBound(World, 2) Then
                        collided = True
                    ElseIf World(xpos, ypos) Then
                        collided = True
                    End If
                Else
...
Private Sub NewShape()
    ...
    Randomize
    currentshape = 1 + Int(Rnd * UBound(shapes))

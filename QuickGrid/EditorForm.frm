...
'    NewFile
'
'    FilePicker.Filter = "pdl"
'    If Command <> "" Then
'        sFile = StripQuotes(Command)
'        DoEvents
'        DoEvents
'        LoadFile sFile
'
'        On Error Resume Next
'        Me.Width = GetSetting("SaffronEditor", LCase$(mFileName), "Width", Me.ScaleWidth)
'        Me.Height = GetSetting("SaffronEditor", LCase$(mFileName), "Height", Me.ScaleHeight)
'        On Error GoTo 0
'    End If
'    bSaveOnResize = True
...
'
'    'ShowScrollBar EditorForm.hwnd, SB_BOTH, 1000
'End Sub
'
...
'
'        If mFileName <> "" Then
'            SaveSetting "PDLEditorLite", LCase$(mFileName), "Width", Me.Width
'            SaveSetting "PDLEditorLite", LCase$(mFileName), "Height", Me.Height
'        End If
'    End If
'End Sub
'
...
'Public Sub NewFile()
'    mFileName = ""
'    Caption = "Untitled - Saffron Editor"
'    InitialiseConstants
'    InitialiseCursor
'    InitialiseLines ""
'    bInitialised = True
...
'
'    For iLineIndex = 1 To UBound(Lines)
'        sProgram = sProgram & vbCrLf & Lines(iLineIndex).Text
'    Next
'    sProgram = Mid$(sProgram, 3)
'
'    vRuleNames = GetRules(sProgram)
'
'    ReDim Lines(1 To 1) As LineCode
'
'    iNext = 1
'    iLineIndex = 1
'    Do
'        vAdjustedLine = ParseLine(Mid$(sProgram, iNext), iParseLength, bParsedOk, vRuleNames)
'        If bParsedOk Then
...
'    If Lines(UBound(Lines)).Text <> "" Then
'        ReDim Preserve Lines(1 To UBound(Lines) + 1)
'    End If
'    For iLineIndex = 1 To UBound(Lines)

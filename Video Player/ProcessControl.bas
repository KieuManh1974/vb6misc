...
Public Function OpenApplication(ByVal sPath As String, ByVal sFolderPath As String, Optional lTimeout As Single) As Long
...
Public Function CloseApplication(lprocessid As Long)
    Dim x As Long
...
Public Function Wait(ByVal lTimeout As Single, lprocessid As Long)
    WaitForSingleObject lprocessid, CLng(lTimeout * 1000)
End Function

Public Sub PressSingleKey(lKeyCode As Long, Optional iType As Long)
    Dim VK As Integer
